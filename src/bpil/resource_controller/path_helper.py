"""
This module provides access to the most often used paths in the rmm4pycore and provides functionalities to look for
...
def get_folder_path(enum):
    """
    Returns path to a subfolder in epmc_llm
